...
select * from unpaidProgram_table limit 10;
...
begin
   ...
   raise notice '------------------------------';
   raise notice 'Unpaid Total Reviews: %', up_review_count;
   raise notice 'Unpaid 5-Star Reviews: %', up_five_star_count;
   raise notice 'Unpaid Five Star Percentage: %', (up_five_star_count::float / up_review_count::float) * 100;
end; $$;
